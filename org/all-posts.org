...
#+end_export
* DONE Amboy and the Mother Road                                       :travel:americana:route66:
CLOSED: [2026-05-09 Sat 00:28]
:PROPERTIES:
:EXPORT_FILE_NAME: amboy-mother-road
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :topics '("Travel" "Americana" "Route 66")
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :description "A photo journal off the Interstate and onto the Mother Road — Sedona to L.A. by way of Lilo's, Amboy, and Roy's neon at dusk."
:EXPORT_HUGO_CUSTOM_FRONT_MATTER+: :images '("https://rm.rmdashrf.net/ox-hugo/DSC_0811-hdr.jpg")
:END:

# Working title — pivot freely. Slug ~amboy-mother-road~ also placeholder.
# Story angle still open. Spiral will draft once direction is chosen.

   #+begin_export html
   <style>
   .amboy-journal figure { margin: 1.25rem 0; clear: both; }
   .amboy-journal figure img { max-height: 540px; width: auto; max-width: 100%; margin: 0 auto; display: block; }
   .amboy-journal img.amboy-float-right { float: right; max-width: 320px; max-height: none; margin: 0 0 0.75rem 1.5rem; border-radius: 0.375rem; }
   .amboy-journal img.amboy-float-left  { float: left;  max-width: 320px; max-height: none; margin: 0 1.5rem 0.75rem 0; border-radius: 0.375rem; }
   .amboy-journal .amboy-pair { display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem; margin: 1.25rem 0; clear: both; }
   .amboy-journal .amboy-pair figure { margin: 0; clear: none; }
   .amboy-journal .amboy-pair img { width: 100%; height: auto; max-height: none; margin: 0; border-radius: 0.375rem; display: block; }
   .amboy-journal .amboy-pair figcaption { margin: 0.5rem 0 0; line-height: 1.5; color: inherit; font-size: inherit; }
   @media (max-width: 540px) { .amboy-journal .amboy-pair { grid-template-columns: 1fr; } }
   .amboy-journal hr { clear: both; border: 0; border-top: 1px solid currentColor; opacity: 0.25; max-width: 6rem; margin: 2.75rem auto; }
   .amboy-journal::after { content: ""; display: block; clear: both; }
   </style>
   <div class="amboy-journal">
   #+end_export

   #+attr_html: :alt Forested red-rock walls of Oak Creek Canyon viewed from above under a deep blue sky
   [[./img/amboy/DSC_0618-hdr.jpg]]
   More than 300 million years of earth's history. Winding up and out of Oak Creek Canyon.

   -----

   #+begin_export html
   <img src="/ox-hugo/DSC_0653.jpg" class="amboy-float-right" alt="Westside Lilo's Route 66 sign">
   #+end_export
   ...
   #+attr_html: :alt Inside Lilo's: wood-paneled walls and ceiling, wooden tables and chairs, a few diners at lunch
   [[./img/amboy/2026-04-30_restaurant-interior_web.jpg]]

   #+begin_export html
   <img src="/ox-hugo/2026-04-30_13.25.49.jpg" class="amboy-float-right" style="max-width: 390px;" alt="Anaheim chili burger at Lilo's">
   #+end_export
   ...
   #+attr_html: :alt Two-lane road through the Mojave seen from the driver's seat, side mirror in the corner, distant mountains under scattered clouds
   [[./img/amboy/2026-04-30_17.28.29.jpg]]
   ...
   #+attr_html: :alt Abandoned Amboy School behind a chain-link gate, weathered school sign overhead, mountains beyond
   [[./img/amboy/DSC_0710.jpg]]
   Amboy, where the past becomes the present of the past.

   #+attr_html: :alt Amboy post office in afternoon light: low white building with blue trim, palm tree, US flag, Route 66 painted on the asphalt
   [[./img/amboy/DSC_0679-hdr_02.jpg]]
   Amboy wants you to know, I am not a ghost town. (Yes, Amboy has a working post office.)

   #+begin_export html
   <div class="amboy-pair">
     <figure>
       <img src="/ox-hugo/DSC_0680-hdr.jpg" alt="A couple walks into the Route 66 shot at Amboy">
       <figcaption>But wait. An Italian couple bombed my shot!</figcaption>
     </figure>
     <figure>
       <img src="/ox-hugo/DSC_0689-hdr.jpg" alt="The Italian couple poses in front of the Amboy post office">
       <figcaption>(Good thing they spoke English.) I offered to send them photos, we exchanged emails. Then they asked for a couples shot. Forza Italia! 🇮🇹</figcaption>
     </figure>
   </div>
   #+end_export

   #+attr_html: :alt Cars heading west on Route 66 across the Mojave under a wide cloud-streaked sky
   [[./img/amboy/DSC_0724-hdr.jpg]]
   Others are heading out, but I'm not done yet.
   
   #+attr_html: :alt Full moon rising over distant mountains across the Mojave at dusk
   [[./img/amboy/DSC_0749-hdr.jpg]]
   The sun sets in the West, the moon rises in the East. As it ever was.
   
   #+attr_html: :alt Roy's Motel & Cafe neon sign at twilight: 'No Vacancy' glowing red, 'Motel Cafe' lit in yellow and white, deep blue sky fading to amber at the horizon
   [[./img/amboy/DSC_0811-hdr.jpg]]
